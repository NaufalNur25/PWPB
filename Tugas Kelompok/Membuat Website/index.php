            ...
            <ul>
               ...
               <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="img/backgrounds/bg.jpg" data-delay="10000" data-saveperformance="on" data-title="We Are FourGalery">
                  ...
                  <div class="tp-caption sft"
                     ...
                     <h2 class="home-heading op-1">We Are FourGalery</h2>
                  </div>
                  <!-- Home Subheading -->
                  ...
                  <div class="tp-caption home-button sft fadeout"
                                        ...
                                        style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                     <div class="op-1">
                        <a href="#Gallery" class="btn btn-primary btn-scroll">
                           Gallery
                        </a>
                     </div>
                  </div>
               ...
               <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="img/backgrounds/bg-1.jpg" data-delay="10000"  data-saveperformance="on" data-title="SMKN 4 Bandung">
                  ...
                  <div class="tp-caption sft"
                                        ...
                                        data-endspeed="300"
                                        style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                     <h2 class="home-heading op-2">We Are FourGalery</h2>
                  </div>
                  <!-- Home Subheading -->
               ...
               <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="img/backgrounds/bg-2.jpg" data-delay="10000"  data-saveperformance="on" data-title="FourGalery">
                  ...
                  <div class="tp-caption sft"
                                        ...
                                        data-endspeed="300"
                                        style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                     <h2 class="home-heading op-3">We Are FourGalery</h2>
                  </div>
                  <!-- Home Subheading -->
                  <div class="tp-caption home-subheading sft fadeout"
                                        data-x="center" 
...
<div class="site-wrapper content">
   ...
   <section id="about">
      <div class="container">
         <div class="col-md-12 text-center wow fadeInUp">
            ...
            <p class="subheading">Kami Team<span class="highlight"> Fourgallery</span>, sedang mencoba membuat website</p>
         </div>
         <div class="row features-row wow fadeInUp">
            <div class="col-md-4 col-sm-12 feature-column">
               ...
               <div class="feature-info">
                  <h4>Menganalisa</h4>
                  <p class="feature-description"><strong>Penting</strong> melihat dan menganalisa code yang akan kami eksekusi</p>
               </div>
            </div>
            <div class="col-md-4 col-sm-12 feature-column">
               <div class="feature-icon">
               ...
               <div class="feature-info">
                  <h4>Lisensi</h4>
                  <p class="feature-description">Kami tetap menggunakan website ini hanya untuk <strong>keperluan tugas</strong>, tidak ada niat untuk membuatnya menjadi publik</p>
               </div>
            </div>
            <div class="col-md-4 col-sm-12 feature-column">
               <div class="feature-icon">
               ...
               <div class="feature-info">
                  <h4>Pengerjaan</h4>
                  <p class="feature-description">Kami mengerjakan project yang diberikan dengan waktu <strong>2 Minggu</strong></p>
               </div>
            </div>
         </div>
         <div class="row wow fadeInUp">
            <div class="col-md-4 col-sm-12 feature-column">
               ...
               <div class="feature-info">
                  <h4>Deskripsi Pengerjaan</h4>
                  <p class="feature-description">Dipegang langsung oleh team kami yang berkeahlian langsung dalam <strong>Back End</strong> dan <strong>Front End</strong></p>
               </div>
            </div>
            <div class="col-md-4 col-sm-12 feature-column">
               <div class="feature-icon">
               ...
               <div class="feature-info">
                  <h4>Rekayasa Prangkat Lunak</h4>
                  <p class="feature-description">SMKN 4 Bandung dengan kelas Jurusan <strong>Rekayasa Prangkat Lunak 1</strong></p>
               </div>
            </div>
            <div class="col-md-4 col-sm-12 feature-column">
               <div class="feature-icon">
               ...
               <div class="feature-info">
                  <h4>Berlatih</h4>
                  <p class="feature-description"><strong>Berlatih dan mencari banyak pengalaman.</strong> Menjadi siswa yang berkopetensi tinggi adalah tujuan kami</p>
               </div>
            </div>
         </div>
      </div>
   ...
   <section class="informasi">
        <div class="container">
            <div class="row title mx-0">
                <h3 class="mr-auto scroll-show" style="opacity: 1; margin-top: 0px; color: white;">Informasi Sekolah SMKN 4 Bandung</h3>
                <a href="https://smkn4bdg.sch.id/" class="btn btn-primary btn-lg scroll-show" style="opacity: 1; margin-top: 0px;">Selengkapnya</a>
            </div>
        </div>
    </section>
    <!--End Informasi-->
   ...
   <section id="team">
      <div class="container">
         <div class="col-md-12 text-center wow fadeInUp">
            <h3 class="section-title">Tim Kita</h3>
            <p class="subheading">Tim interdisipliner <span class="highlight">ide cemerlang</span> dan tantangan.</p>
         </div>
         <div class="row">
   ...
   <section id="Gallery" style="position: relative;">
      ...
      <div class="container-fluid">
         <div class="col-md-12 text-center">
            <h3 class="section-title wow fadeInUp">FourGalery</h3>
   ...
   <div class="map">
   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.5728599129015!2d107.6266874140989!3d-6.941541769879901!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e86413eb50ad%3A0xf9930b5268e3fee1!2sSMKN%204%20Bandung!5e0!3m2!1sid!2sid!4v1636868666349!5m2!1sid!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
   </div>
   ...
   <footer id="footer">
      ...
      <div class="footer-copyright">
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                  <h3 class="section-title wow fadeInUp">Fourgallery</h3>
